...
function highlightFeature(e) {
    ...
    // if you hover over something, it creates a dashboard 
...
// create an empty function that dumps the data that is being fed into it into the console.
//function createDashboard(properties){
	//console.log(properties)
//}

// hovering on each item can create a chart
function createDashboard(properties){
	...
	// chart title
	let title =  properties['Qualifying Name'];
	...
	// data fields are labels 
	let fields = ['Less than $25K','$25K to $50K','$50K to $75K','$75K to $100K','$100K or More'];

	// set chart options = bar chart or pie chart 
    // pie chart 
    let options = {
		chart: {
			type: 'pie',
...
//function takes a geoid (FIPS code) and zooms the map to its boundary
