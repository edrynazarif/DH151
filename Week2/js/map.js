    ...
    data.forEach(function(item,index){
        ...
        // using loop + jquery to bring data to sidebar
	         // $('.sidebar').append(item.title)

        // using loop + jquery + wrapping content in div container (sidebar-item) + adding a class attribute so that we can style it later 
        // add data to sidebar
    ...
    $('.sidebar').append(`<div class="sidebar-item">${item.title}</div>`)
        ...
        // onclick alert box to call variable item.title using ${} 
...
function flyToIndex(index){
    ...
    //featureGroup needs to be added. Class was moving too quickly, I couldn't really keep up. 
